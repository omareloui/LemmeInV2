<template>
  <path
    d="M0,16c0,6.6,3.9,12.2,9.6,14.7c0-1.1,0-2.5,0.3-3.7c0.3-1.3,2.1-8.7,2.1-8.7s-0.5-1-0.5-2.5
      ...
      c-1.7,0-3.4-0.9-3.9-2c0,0-0.9,3.7-1.1,4.4c-0.3,1.2-1,2.5-1.6,3.4c1.5,0.4,3,0.7,4.5,0.7c8.8,0,16-7.2,16-16c0-8.8-7.2-16-16-16
      C7.2,0,0,7.2,0,16z"
  />
</template>
